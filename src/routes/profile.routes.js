...
router.patch("/me", authMiddleware.requireAuth, validationMiddleware.validateUpdateProfile, profileController.updateMyProfile);
router.delete("/me", authMiddleware.requireAuth, validationMiddleware.validateDeleteAccount, profileController.deleteMyAccount);
...
router.put("/me/email", authMiddleware.requireAuth, validationMiddleware.validateEmailChange, profileController.initiateEmailChange);
